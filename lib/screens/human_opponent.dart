...
class PlayHumanScreen extends StatefulWidget {
  const PlayHumanScreen({super.key, required this.title});

  final String title;

  @override
  _PlayHumanScreenState createState() => _PlayHumanScreenState();
}

class _PlayHumanScreenState extends State<PlayHumanScreen> {
